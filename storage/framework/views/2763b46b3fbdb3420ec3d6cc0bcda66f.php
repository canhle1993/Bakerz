            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 mb-n25">
                ...
                <div class="col mb-25">
                    <div class="team-3-wrapper">
                        ...
                        <div class="team-3-content">
                            <div class="team-3-head">
                                <span class="team-3-name">Kristin Watson</span>
                                <span class="team-3-designation">Chef</span>
                            </div>
                            <p class="team-3-text">Aliqua id fugiat nostrud irure ex duis ea quis id quis ad et. Sunt qui esse pariatur duis…</p>
                            <ul class="team-3-social">
                                <li>
                ...
                <div class="col mb-25">
                    <div class="team-3-wrapper">
                        ...
                        <div class="team-3-content">
                            <div class="team-3-head">
                                <span class="team-3-name">Darrell Steward</span>
                                <span class="team-3-designation">Chef</span>
                            </div>
                            <p class="team-3-text">Aliqua id fugiat nostrud irure ex duis ea quis id quis ad et. Sunt qui esse pariatur duis…</p>
                            <ul class="team-3-social">
                ...
                <div class="col mb-25">
                    <div class="team-3-wrapper">
                        ...
                        <div class="team-3-content">
                            <div class="team-3-head">
                                <span class="team-3-name">Albert Flores</span>
                                <span class="team-3-designation">Chef</span>
                            </div>
                            <p class="team-3-text">Aliqua id fugiat nostrud irure ex duis ea quis id quis ad et. Sunt qui esse pariatur duis…</p>
                            <ul class="team-3-social">
                ...
                <div class="col mb-25">
                    <div class="team-3-wrapper">
                        ...
                        <div class="team-3-content">
                            <div class="team-3-head">
                                <span class="team-3-name">Brooklyn Simmons</span>
                                <span class="team-3-designation">Chef</span>
                            </div>
                            <p class="team-3-text">Aliqua id fugiat nostrud irure ex duis ea quis id quis ad et. Sunt qui esse pariatur duis…</p>
                            <ul class="team-3-social">
                ...
                <div class="col mb-25">
                    <div class="team-3-wrapper">
                        ...
                        <div class="team-3-content">
                            <div class="team-3-head">
                                <span class="team-3-name">Ronald Richards</span>
                                <span class="team-3-designation">Chef</span>
                            </div>
                            <p class="team-3-text">Aliqua id fugiat nostrud irure ex duis ea quis id quis ad et. Sunt qui esse pariatur duis…</p>
                            <ul class="team-3-social">
...
<?php /**PATH C:\xampp\htdocs\bakerz\resources\views/client/pages/our-chef.blade.php ENDPATH**/ ?>