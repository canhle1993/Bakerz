        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    <form id="delete-client-form-<?php echo e($client->user_id); ?>" action="<?php echo e(route('client.destroy', $client->user_id)); ?>" method="POST" style="display:inline-block;">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('DELETE'); ?>
                        <button type="button" class="btn btn-sm btn-danger" onclick="confirmDeleteClient('<?php echo e($client->user_id); ?>')">
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Bakerz\resources\views/admin/manage-client.blade.php ENDPATH**/ ?>