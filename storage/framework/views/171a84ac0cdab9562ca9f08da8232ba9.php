<form id="filterForm" method="GET" action="<?php echo e(route('client.heathyfilter')); ?>">
    ...
    <?php $__currentLoopData = $heathyCatalogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catalog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div>
            <input type="checkbox" name="heath_id[]" value="<?php echo e($catalog->heath_id); ?>"
            ...
            <label for="heath_<?php echo e($catalog->heath_id); ?>"><?php echo e($catalog->heath_catalog); ?></label>
        </div>
...
<?php /**PATH C:\xampp\htdocs\bakerz\resources\views/client/heathyfilter.blade.php ENDPATH**/ ?>