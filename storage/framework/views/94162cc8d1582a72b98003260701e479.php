        ...
        display: inline-block !important;
            ...
            <div class="container-fluid pt-4 px-4">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                     ...
                     <!-- Form tìm kiếm -->
<form class="d-none d-md-flex ms-4" method="GET" action="<?php echo e(route('banner.index')); ?>">
    <div class="input-group">
        <input class="form-control bg-white border-0 ps-3" type="search" placeholder="Banner Title" name="search" value="<?php echo e(request()->query('search')); ?>" style="border-radius: 25px 0 0 25px;">
...
<a id="btnCreate" href="#" class="btn-create">Create Banner</a>
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tr id="row-<?php echo e($banner->banner_id); ?>">
                                <td><?php echo e(($banners->currentPage() - 1) * $banners->perPage() + $loop->iteration); ?></td>
                                <td>
                                    <img src="<?php echo e(asset('storage/banners/' . $banner->image_banner)); ?>" alt="Hình ảnh" width="100" class="mt-2">
                                </td>
                                <td>
                                    <img src="<?php echo e(asset('storage/banners/' . $banner->image_product)); ?>" alt="Hình ảnh" width="100" class="mt-2">
                                </td>
                                <td><?php echo e($banner->title1); ?></td>
                                <td><?php echo e($banner->title2); ?></td>
                                <td><?php echo e($banner->description); ?></td>
                                <td>
                                <a href="javascript:void(0);" class="bi bi-pencil m-2"
                                data-banner-id="<?php echo e($banner->banner_id); ?>"
                                data-update-url="<?php echo e(route('banner.update', ['banner' => $banner->banner_id])); ?>"
                                onclick="editRow(this)"></a>
                                <a class="btn btn-outline-danger m-2" href="#" data-url="<?php echo e(route('banner.destroy', $banner->banner_id)); ?>" onclick="showDeleteModal(this)">Delete</a>
                                </td>
                            </tr>
                    ...
                    <div class="d-flex justify-content-center">
                        <?php echo e($banners->appends(request()->except('page'))->links('pagination::bootstrap-4')); ?>
...
function editRow(element) {
    ...
    let url = isEdit ? updateUrl : "<?php echo e(route('banner.store')); ?>";
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.status === 'success') {
                ...
                window.location.href = "<?php echo e(route('banner.index')); ?>"; // Điều hướng tới trang danh sách banner
            } else {
  ...
  function loadProducts() {
    ...
    $.ajax({
        url: "<?php echo e(route('product.index2')); ?>", // Đường dẫn để lấy lại giỏ hàng từ session
        method: "GET",
        data: {
        ...
        success: function(response) {
            ...
            if (response.status === 'success' && response.data.products) {
                ...
                products.forEach(product => {
                    var imageUrl = `<?php echo e(asset('storage/products/')); ?>/${product.image}`;
                    const row = `
                        <tr>
    ...
    document.getElementById('reset-search').addEventListener('click', function() {
            window.location.href = "<?php echo e(route('banner.index')); ?>";
    });
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Bakerz\resources\views/admin/banner/bannerlist.blade.php ENDPATH**/ ?>