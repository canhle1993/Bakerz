...
<div class="row mb-4">
    <div class="col-md-8 offset-md-2">
        <form method="GET" action="<?php echo e(route('order.pending')); ?>" class="input-group">
    ...
    <div class="col-md-2 text-end">
        <a href="<?php echo e(route('order.pending')); ?>" class="btn btn-secondary">Reset</a>
    </div>
</div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <button data-order-id="<?php echo e($item->order_id); ?>" style="color: black;" class="btn btn-sm btn-outline-info view">
                        View
                    </button>
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Bakerz\resources\views/admin/orders/pending.blade.php ENDPATH**/ ?>