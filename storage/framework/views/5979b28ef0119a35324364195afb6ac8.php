...
<div class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="">Pending Order Management</h1>
...
<div class="row">
    ...
    <div class="col-md-4">
    <form method="GET" action="<?php echo e(route('order.pending')); ?>" class="mb-4">
        <div class="input-group">
            <input type="text" name="searchOrderID" class="form-control" placeholder="Search by Order ID" value="<?php echo e(request()->query('searchOrderID')); ?>">
            <button type="submit" class="btn btn-primary">Search</button>
        </div>
    </form>
    </div>
    <div class="col-md-4">
    <a href="<?php echo e(route('order.pending')); ?>" class="btn btn-secondary">Reset</a> <!-- Nút reset tìm kiếm -->
