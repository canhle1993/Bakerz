...
<div class="section-padding-03 pt-0">
    <div class="container">
        ...
        <div class="product-active">
            <div class="swiper">
                <div class="swiper-wrapper">
                    <?php if($recentPurchasedProducts->isEmpty()): ?>
                        <p>----- No products found.</p>
                    <?php else: ?>
                        <?php $__currentLoopData = $recentPurchasedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="swiper-slide">
                            <div class="product-item text-center">
                                <div class="product-item__image border w-100">
                                    <a href="<?php echo e(route('product.single', ['product' => $product->product_id])); ?>">
            ...
            <div class="row row-cols-lg-2 row-cols-md-2 row-cols-1 align-items-center mb-n30">
                <div class="col mb-30">
                    <div class="deal-two_images">
                        ...
                        <img class="deal-two_thumb" src="<?php echo e(asset('storage/' . $deal->image)); ?>" alt="<?php echo e($deal->name); ?>">
                ...
                <div class="col mb-30">
                    <div class="deal-two_content">
                        ...
                        <!-- Thêm tên deal -->
                        <h4 class="deal-two_title"><?php echo e($deal->name); ?></h4>
                        <div class="countdown-area">
                            <!-- Thêm ngày khuyến mãi -->
                            <div class="countdown-wrapper" data-countdown="<?php echo e($deal->promotion_date); ?>"></div>
                        </div>
                        <!-- Thêm giá tiền -->
                        <span class="deal-two_price"><span>$</span><?php echo e(number_format($deal->price, 2)); ?></span>
                        ...
                        <ul class="product-item__meta deal-two_meta">
                            <li class="product-item__meta-action">
                                ...
                                class="shadow-1 labtn-icon-cart add-to-cart"
                                href="#"
                                data-product-id="<?php echo e($deal->product_id); ?>"
                                ></a>
                            </li>
                            <li class="product-item__meta-action">
                                <a
                            ...
                            <li class="product-item__meta-action">
                                <a class="labtn-icon-wishlist" href="#" data-product-id="<?php echo e($deal->product_id); ?>" data-bs-tooltip="tooltip" data-bs-placement="top" title="Add to wishlist"></a>
                            </li>
                        </ul>
  ...
  <div class="product-row">
      ...
      <div class="product-active-three">
        <div class="swiper">
          <div class="swiper-wrapper">
            ...
            <?php else: ?> <?php $__currentLoopData = $bestSellingProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="swiper-slide">
              <!-- Product Item Start -->
              <div class="product-item product-item-05 border text-center">
                ...
                <div class="product-item__image">
                  ...
                  >
                    <img
                      width="250"
                      height="250"
                      src="<?php echo e($product->image ? asset('storage/products/' . $product->image) : asset('path/to/default-image.jpg')); ?>"
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="product-active-four mt-4">
                    <div class="swiper">
                        <div class="swiper-wrapper">
                        <?php if($seasonalProducts->isEmpty()): ?>
                        <p>No best-selling products found.</p>
                        <?php else: ?> <?php $__currentLoopData = $seasonalProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <!-- swiper-slide start -->
                            <div class="swiper-slide">
                                <!-- Product Item Start -->
                                <div class="product-item product-item-06 border text-center">
                                    ...
                                    <div class="product-item__content">
                                        <h5 class="product-item__title"><a href="single-product.html"><?php echo e($product->product_name); ?></a></h5>
                                        <span class="product-item__price">
                                            <?php if($product->price != $product->getDiscountedPrice()): ?>
                                            <del><?php echo e(formatPriceVND($product->price)); ?></del>
                                            <!-- Giá gốc -->
                                        ...
                                        <p class="product-item__text"><?php echo e(\Illuminate\Support\Str::limit($product->describe, 70, '...')); ?>                                        </p>
                                        <a href="#/" class="product-item__btn add-to-cart" data-product-id="<?php echo e($product->product_id); ?>" >Add to cart</a>
                                    </div>
                                </div>
                                <!-- Product Item End -->
                            </div>
    ...
    <div class="custom-container-four container-fluid ">
        <div class="row pt-5">
            ...
            <div class="col-12">
                <?php echo $__env->make('layouts.autoplay', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row row-cols-xl-3 row-cols-lg-2 row-cols-md-2 row-cols-1 mb-n30" style="margin-bottom: 10px !important;">
                <div class="col mb-30">
                    ...
                    <a href="<?php echo e(route('contact')); ?>" class="callto-action-03">
...
<?php /**PATH /Applications/C2310L._Group1._BakerBite/bakerz/resources/views/client/home.blade.php ENDPATH**/ ?>