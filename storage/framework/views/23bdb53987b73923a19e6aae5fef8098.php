                        ...
                        <div class="product-group">
                            <div class="product-group-list">
                                ...
                                <div class="product-group-content">
                                    <h4 class="title"><a href="single-product.html">No-bake chocolate</a></h4>
                                    <p class="price">$95.00</p>
                                    <p class="in-stock">342 in stock</p>
                                </div>
                            </div>
                            <div class="product-group-list">
                                <!-- Quantity Start -->
                                ...
                                <!-- Quantity End -->
                                <div class="product-group-content">
                                    <h4 class="title"><a href="single-product.html">Chocolate Bake</a></h4>
                                    <p class="price">$45.00</p>
                                    <p class="in-stock">555 in stock</p>
                                </div>
                            </div>
                        </div>
                        <!-- Product Group Lists End -->
...
<?php /**PATH C:\xampp\htdocs\ProjectBaker\resources\views/client/shop/product-types/product-grouped.blade.php ENDPATH**/ ?>