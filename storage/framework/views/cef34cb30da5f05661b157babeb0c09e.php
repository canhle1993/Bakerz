            ...
            <div class="row">
                <div class="col-12 section-padding-04">
                    <div class="row row-cols-sm-2 row-cols-md-2 row-cols-lg-3 gx-lg-5 gx-xxl-12">
                        ...
                        <div class="cols">
                            <div class="blog-post-two">
                                <a href="<?php echo e(route('blog-pd', $blog->blog_id)); ?>" class="blog-post-two_thumb">
                                    <img src="<?php echo e($blog->image ? asset('storage/' . $blog->image) : asset('assets/images/default-blog-image.jpg')); ?>" alt="Blog Image">
                                ...
                                <div class="blog-post-two__content">
                                    <ul class="blog-post-two__meta">
                                        ...
                                        <li>-</li>
                                        <li><span><?php echo e(\Carbon\Carbon::parse($blog->created_at)->format('M d, Y')); ?></span></li>
                                    </ul>
                                    <h3 class="blog-post-two__title">
                                        <a href="<?php echo e(route('blog-pd', $blog->blog_id)); ?>"><?php echo e($blog->blog_name); ?></a>
                                    </h3>
                                    <a href="<?php echo e(route('blog-pd', $blog->blog_id)); ?>" class="blog-post-two__btn">Read More 
                    ...
                    <div class="shop-bottombar mt-0">
                        <div class="pagination"><?php echo e($blogs->links('client.custom-pagination')); ?></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\bakerz\resources\views/client/blog/blog.blade.php ENDPATH**/ ?>