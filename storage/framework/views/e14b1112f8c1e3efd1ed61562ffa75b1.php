                                            ...
                                            <ul class="product-item__meta meta-middle">
                                                <li class="product-item__meta-action">
                                                    <a class="labtn-icon-quickview" href="#" data-bs-tooltip="tooltip" data-bs-placement="top"
                                                       ...
                                                       onclick="loadQuickView(<?php echo e($product->product_id); ?>)">
                                                    </a>
                                                </li>
                                                <li class="product-item__meta-action">
                                                    <a class="labtn-icon-cart" href="javascript:void(0);" data-bs-tooltip="tooltip" data-bs-placement="top" title="Add to cart" onclick="addToCart(<?php echo e($product->product_id); ?>)"></a>
                                                </li>
...
<?php /**PATH C:\xampp\htdocs\ProjectBaker\resources\views/client/shop/shop_all.blade.php ENDPATH**/ ?>