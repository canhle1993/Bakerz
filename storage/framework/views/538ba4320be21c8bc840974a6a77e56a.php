            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tr id="row-<?php echo e($catalog->category_id); ?>">
                                ...
                                <td>
                                    <!-- <a href="javascript:void(0);" class="bi bi-pencil m-2" onclick="editRow(<?php echo e($catalog->category_id); ?>, '<?php echo e(route('catalog.update', $catalog->category_id)); ?>')"></a> -->
                    ...
                    <div class="d-flex justify-content-center">
                        <?php echo e($catalogs->links('pagination::bootstrap-4')); ?>
