                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <form class="d-none d-md-flex ms-4" method="GET" action="<?php echo e(route('catalog.index')); ?>">
                            <div class="input-group">
                                <input class="form-control bg-white border-0 ps-3" type="search" placeholder="Category name" name="search" value="<?php echo e(request()->query('search')); ?>">
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tr id="row-<?php echo e($catalog->category_id); ?>"  style="background-color: #f9f9f9; transition: background-color 0.3s ease;">
                                ...
                                <td>
                                <img src="<?php echo e(asset('storage/catalogs/' . $catalog->image)); ?>" alt="Image" width="100" class="mt-2" style="border-radius: 5px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); transition: transform 0.3s ease;">                                </td>
