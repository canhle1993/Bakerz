...
<body>
    ...
    <div class="coming">
        <div class="coming-col order-2 order-md-1">
            <div class="coming-content">
                ...
                <p class="coming-text">Something unexpected is about to happen</p>
                <div class="coming-wrapper" data-countdown="2024/12/28"></div>
        ...
        <div class="coming-col coming-bg order-1 order-md-2" data-bg-image="assets/images/bg/coming-soon.jpg">
            <a href="index.html">
    ...
    <a href="<?php echo e(route('client.home')); ?>" class="container">
...
<?php /**PATH C:\xampp\htdocs\bakerz\resources\views/client/pages/coming-soon.blade.php ENDPATH**/ ?>