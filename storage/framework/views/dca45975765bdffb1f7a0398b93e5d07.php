                            ...
                            <tr>
                                ...
                                <th class="wishlist-thumb">
                                    <a href="<?php echo e(route('product.single', ['product' => $item->product_id])); ?>">
                                        <img src="<?php echo e(asset('storage/products/' . $item->product->image)); ?>" alt="<?php echo e($item->product_name); ?>">
                                    </a>
                                </th>
                                <th class="text-start">
                                    <a href="<?php echo e(route('product.single', ['product' => $item->product_id])); ?>">
                                ...
                                <?php if($item->product->inventory > 0): ?>
                                In Stock
                                <?php else: ?>
                                Out Stock
                                <?php endif; ?>
                                </td>
                                <?php if($item->product->price != $item->product->getDiscountedPrice()): ?>
                                <td>
                                    <del><?php echo e(formatPriceVND($item->product->price)); ?></del>
                                    <!-- Giá gốc -->
                                
                                    <strong style="color: red;"
                                    >$<?php echo e(number_format($item->product->getDiscountedPrice(),2)); ?></strong>
                                </td>
                                <?php else: ?>
...
</html><?php /**PATH C:\xampp\htdocs\bakerz\resources\views/client/shop/others/wishlist.blade.php ENDPATH**/ ?>