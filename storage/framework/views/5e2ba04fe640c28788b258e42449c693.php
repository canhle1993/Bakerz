...
<div class="row">
    ...
    <div class="col-md-4">
    <form method="GET" action="<?php echo e(route('order.confirmed')); ?>" class="mb-4">
    ...
    <div class="col-md-4">
    <a href="<?php echo e(route('order.confirmed')); ?>" class="btn btn-secondary">Reset</a> <!-- Nút reset tìm kiếm -->
