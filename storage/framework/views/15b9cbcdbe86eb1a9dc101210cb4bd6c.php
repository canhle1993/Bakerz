    ...
    <div class="row pt-3">
        ...
        <div class="col-md-10">
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <a href="<?php echo e(route('product.index')); ?>">Cancel</a>
                </button>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ProjectBaker\resources\views/admin/newproduct.blade.php ENDPATH**/ ?>