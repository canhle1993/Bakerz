...
<div class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="">Confirmed Order Management</h1>
    ...
    <form method="GET" action="<?php echo e(route('order.paid')); ?>" class="mb-4">
    ...
    <div class="col-md-4">
    <a href="<?php echo e(route('order.paid')); ?>" class="btn btn-secondary">Reset</a>
