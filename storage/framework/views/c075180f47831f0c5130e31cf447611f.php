  ...
  <body>
    <div class="wrapper">
      <div class="container">
        ...
        <form class="form" method="POST" action="<?php echo e(route('getpass')); ?>">
          <?php echo csrf_field(); ?>
          <input
            type="email"
          ...
          <a
            ...
            class="small"
            style="color: rgb(8 255 24)"
            >Login</a
          >
          <p class="text-white mb-5 pb-lg-2">
            Don't have an account?
            <a href="<?php echo e(route('register')); ?>" style="color: #0014f2"
              >Register</a
            >
          </p>
        </form>
...
<?php /**PATH C:\xampp\htdocs\baker-bite\resources\views/auth/getpass.blade.php ENDPATH**/ ?>