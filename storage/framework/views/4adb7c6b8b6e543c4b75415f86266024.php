...
<div class="container mt-5">
    ...
    <div class="row mb-4">
        <div class="col-md-8 offset-md-2">
            <form method="GET" action="<?php echo e(route('order.paid')); ?>" class="input-group">
                <input type="text" name="searchOrderID" class="form-control bg-white border-0 ps-3" placeholder="Search by Order ID" value="<?php echo e(request()->query('searchOrderID')); ?>" style="border-radius: 25px 0 0 25px;">
        ...
        <div class="col-md-2 text-end">
            <a href="<?php echo e(route('order.paid')); ?>" class="btn btn-secondary">
                Reset
            </a>
        </div>
    </div>
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Bakerz\resources\views/admin/orders/paid.blade.php ENDPATH**/ ?>