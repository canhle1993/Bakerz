      ...
      Chefs List
        ...
        <div class="row mb-4">
            <div class="col-md-8 offset-md-2">
                <form method="GET" action="<?php echo e(route('admin.chefs.create')); ?>" class="input-group">
                    <input type="text" name="search" class="form-control bg-white border-0 ps-3" placeholder="Search Chef Name" value="<?php echo e(request()->query('search')); ?>" style="border-radius: 25px 0 0 25px;">
            ...
            <div class="col-md-2 text-end">
                <a href="<?php echo e(route('admin.chefs.create')); ?>" class="btn btn-secondary">
                    Reset
                </a>
            </div>
        </div>
    ...
    <script>
        ...
        document.querySelectorAll('.editChefBtn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                const updateUrl = `<?php echo e(route('admin.chefs.update', ':id')); ?>`;
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Bakerz\resources\views/admin/our-chef.blade.php ENDPATH**/ ?>