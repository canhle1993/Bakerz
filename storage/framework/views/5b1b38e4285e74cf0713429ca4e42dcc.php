...
<div class="row">
    ...
    <div class="col-md-4">
        <form action="<?php echo e(route('admin.workshop.index')); ?>" method="GET" class="d-none d-md-flex mb-4">
            <div class="input-group">
                <input type="text" name="search" class="form-control bg-white border-0 ps-3" placeholder="Search by name or product" value="<?php echo e(request()->query('search')); ?>" style="border-radius: 25px 0 0 25px;">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('admin.workshop.index')); ?>" class="btn btn-light" style="border-radius: 25px;">Reset</a> <!-- Sửa route -->
    </div>
</div>
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Bakerz\resources\views/admin/workshop.blade.php ENDPATH**/ ?>