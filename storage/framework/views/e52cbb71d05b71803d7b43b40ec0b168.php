    ...
    <div class="product-row">
        <div class="product-wrapper ps-md-5 ps-lg-6 ps-xl-8 ps-xxl-11 order-2 ">
            ...
            <div class="section-title-05">
                ...
                <a href="<?php echo e(route('client.topProducts')); ?>" class="read-more">
                    ...
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="swiper-slide">
                            ...
                            <div class="product-item__badge">Hot</div>
                                ...
                                <div class="product-item__image">
                                    <a href="<?php echo e(route('single-product', ['id' => $product->product_id])); ?>">
                                        <img width="250" height="250" src="<?php echo e(asset('storage/products/' . $product->image)); ?>" alt="<?php echo e($product->product_name); ?>" />
                                    </a>
                                </div>
                                <div class="product-item__content">
                                    <h5 class="product-item__title">
        ...
        <div class="boxbanner-wrapper order-1">
            <!-- Ad Banner Start -->
            <a href="<?php echo e(route('single-product', ['id' => 1])); ?>" class="boxbanner-bg boxbanner" data-bg-image="assets/images/banner/add-banner-two.jpg">
