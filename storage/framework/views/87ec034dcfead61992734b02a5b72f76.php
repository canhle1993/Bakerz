        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    <form action="<?php echo e(route('admin.destroy', $admin->user_id)); ?>" method="POST" style="display:inline-block;">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ProjectBaker\resources\views/admin/manage-admin.blade.php ENDPATH**/ ?>