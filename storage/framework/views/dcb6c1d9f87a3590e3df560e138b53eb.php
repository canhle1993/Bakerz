        ...
        <div class="container">
            ...
            <form class="form" method="POST" action="<?php echo e(route('register')); ?>">
                ...
                <div style="float: left;">
                    ...
                    <input type="text" id="address" name="address" value="<?php echo e(old('address')); ?>" required autofocus />
                </div>
                ...
                <div style="float: left;">
                    ...
                    <input type="text" id="phone" name="phone" value="<?php echo e(old('phone')); ?>" required autofocus />
                </div>
