    ...
    <div class="wrapper">
        <div class="container">
            ...
            <form class="form" method="POST" action="<?php echo e(route('register')); ?>">
                ...
                <input  type="text" id="name" name="name" value="<?php echo e(old('name')); ?>" required/></div>

                <div style="float: right;"><label class="form-label text-white" for="email">Email</label >
                <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus /></div>  

                <div style="float: left;"><label class="form-label text-white" for="name">Address</label>
                <input type="text" id="address" name="address" value="<?php echo e(old('address')); ?>" required autofocus /></div>
                ...
                <input type="text" id="phone" name="phone" value="<?php echo e(old('phone')); ?>" required autofocus /></div>
              ...
              <button style="margin-top: 5% !important;" type="submit" id="login-button" >Register</button>
                <br />
                <a href="<?php echo e(route('login')); ?>" style="color: rgb(8 255 24); top: 15px; position: relative; left: -18%;">
                  Login
                </a>
            </form>
        </div>
...
<?php /**PATH C:\xampp\htdocs\bakerz\resources\views/auth/register.blade.php ENDPATH**/ ?>