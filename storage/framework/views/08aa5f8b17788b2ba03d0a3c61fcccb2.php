                ...
                <div class="bg-secondary text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tr id="row-<?php echo e($heathy->heath_id); ?>">
                                ...
                                data-category-id="<?php echo e($heathy->heath_id); ?>"
                                data-update-url="<?php echo e(route('heathy.update', ['heathy' => $heathy->heath_id])); ?>"
                                onclick="editRow(this)"></a>
                                <a class="btn btn-outline-danger m-2" href="#" data-url="<?php echo e(route('heathy.destroy', $heathy->heath_id)); ?>" onclick="showDeleteModal(this)">Delete</a>
                                </td>
                            </tr>
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\baker-bite\resources\views/admin/heathylist.blade.php ENDPATH**/ ?>