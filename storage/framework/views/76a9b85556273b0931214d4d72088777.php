    ...
    <div class="wrapper">
        <div class="container">
            ...
            <form class="form" method="POST" action="<?php echo e(route('login')); ?>">
                <?php echo csrf_field(); ?>
                <input type="email" placeholder="Email address" name="email" value="<?php echo e(old('email')); ?>" required autofocus />
                <input type="password" placeholder="Password" name="password" required />
                <button type="submit" id="login-button">Login</button>
                <br />
                <a href="<?php echo e(route('auth.getpass')); ?>" class="small" style="color: rgb(8 255 24)">Forgot password?</a>
                <p class="text-white mb-5 pb-lg-2">
                    Don't have an account? <a href="<?php echo e(route('register')); ?>" style="color: #0014f2">Register here</a>
                </p>
            </form>
        </div>
        <ul class="bg-bubbles">
...
<?php /**PATH /Applications/C2310L._Group1._BakerBite/bakerz/resources/views/auth/login.blade.php ENDPATH**/ ?>