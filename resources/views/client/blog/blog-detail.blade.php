...
<body>
    ...
    <div class="shop-banner shop-banner_bg" data-bg-image="{{ asset('assets/images/bg/home-9-bg1.jpg') }}">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-4 col-md-6 col-sm-6 col-8 order-lg-1 order-md-2 order-2">
                    <div class="shop-banner_one">
                        <img src="{{ asset('assets/images/banner/home9-banner1.jpg') }}" alt="Banner-Image" />
                ...
                <div class="col-lg-4 col-md-12 col-12 order-lg-2 order-1">
                    <div class="shop-banner_content">
                        ...
                        <div class="section-title-09 justify-content-center text-center align-items-center">
                            ...
                            <form id="registerForm" method="POST" action="{{ route('workshop.register') }}">
                                @csrf
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-4 order-lg-3 order-md-3 order-3">
                    <div class="shop-banner_two">
                        <img src="{{ asset('assets/images/banner/home9-banner2.png') }}" alt="Banner-Image" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="menu-banner" data-bg-image="{{ asset('assets/images/bg/home-9-bg2.jpg') }}">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="menu-banner_image">
                        <a href="shop.html"><img src="{{ asset('assets/images/banner/home9-banner3.jpg') }}" alt="Banner-Image" /></a>
                ...
                <div class="col-md-6">
                    <div class="menu-banner_content">
                        <div class="section-title-09 justify-content-start text-start align-items-start">
                            ...
                            <form id="registerForm1" method="POST" action="{{ route('workshop.register') }}">
                                @csrf
    ...
    <div class="gift-banner section-padding-03" data-bg-image="{{ asset('assets/images/bg/home-9-bg3.jpg') }}">
            ...
            <div class="row justify-content-end align-items-center h-100">
                <div class="col-sm-8 col-md-7 col-lg-6">
                    <div class="section-title-09 justify-content-start text-center align-items-center">
                        ...
                        <form id="registerForm2" method="POST" action="{{ route('workshop.register') }}">
                            @csrf
    ...
    <div class="portfolio-banner section-padding-03" data-bg-image="{{ asset('assets/images/bg/home-9-bg2.jpg') }}">
        <div class="container">
            <div class="row mb-n60">
                <div class="col-md-5 mb-60">
                    <div class="section-title-09">
                        ...
                        <form id="registerForm3" method="POST" action="{{ route('workshop.register') }}">
                            @csrf
                ...
                <div class="col-md-7 mb-60 mt-8 mt-md-0">
                    <div class="portfolio-banner_image">
                        <a class="portfolio-banner_image__thumb" href="shop.html">
                            <img src="{{ asset('assets/images/banner/home9-banner4.jpg') }}" alt="Banner-Image" />
                        </a>
...
<!-- ERROR -->
    ...
    <div class="modal-dialog modal-dialog-centered mw-100">
            <div class="custom-content">
                ...
                <div class="modal-body">
                    <i class="fas fa-exclamation-triangle"></i> <span id="errorMessage"> {{ session('iserror') }} </span>
                </div>
            </div>
        </div>
</div>
