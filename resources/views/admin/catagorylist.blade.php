            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                ...
                <form class="d-none d-md-flex ms-4" method="GET" action="{{ route('catalog.index') }}">
                    <div class="input-group">
                        <input class="form-control bg-white border-0 ps-3" type="search" placeholder="Category name" name="search" value="{{ request()->query('search') }}" style="border-radius: 25px 0 0 25px;">
                    ...
                    <tbody>
                        ...
                        @foreach($catalogs as $catalog)
                            <tr id="row-{{ $catalog->category_id }}" style="background-color: #f9f9f9; transition: background-color 0.3s ease;">
                                ...
                                <td>
                                    <img src="{{ asset('storage/catalogs/' . $catalog->image) }}" alt="Image" width="100" class="mt-2" style="border-radius: 5px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); transition: transform 0.3s ease;">
                                </td>
