...
<div class="container mt-5">
    ...
    <div class="row mb-4">
        <div class="col-md-8 offset-md-2">
            <form method="GET" action="{{ route('order.cancel') }}" class="input-group">
        ...
        <div class="col-md-2 text-end">
            <a href="{{ route('order.cancel') }}" class="btn btn-secondary" style="background-color: #6c757d; border-radius: 25px; padding: 12px 20px;">Reset</a>
        </div>
    </div>
