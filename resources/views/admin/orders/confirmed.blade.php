...
<div class="row">
    ...
    <div class="col-md-4">
    <form method="GET" action="{{ route('order.confirmed') }}" class="mb-4">
    ...
    <div class="col-md-4">
    <a href="{{ route('order.confirmed') }}" class="btn btn-secondary">Reset</a> <!-- Nút reset tìm kiếm -->
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    <form action="{{route('order.gotoDelivered', $item->order_id)}}" method="POST" style="display:inline-block;">
                        @csrf
