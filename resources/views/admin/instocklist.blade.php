            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <form class="d-none d-md-flex ms-4" method="GET" action="{{ route('product.index_instock') }}">
                                ...
                                <tr class="text-white">
                                    ...
                                    <th scope="col">
                                        ...
                                        <div style="float: right;">
                                            <a href="{{ route('product.index_instock', array_merge(request()->all(), ['sort' => 'name_asc'])) }}">
                                                <i class="fas fa-arrow-up"></i>
                                            </a>
                                            <a href="{{ route('product.index_instock', array_merge(request()->all(), ['sort' => 'name_desc'])) }}">
                                    ...
                                    <th scope="col">
                                        Category
                                        <div style="float: right;">
                                            <a href="{{ route('product.index_instock', ['sort' => 'category_asc']) }}">
                                                <i class="fas fa-arrow-up"></i>
                                            </a>
                                            <a href="{{ route('product.index_instock', ['sort' => 'category_desc']) }}">
                                                <i class="fas fa-arrow-down"></i>
                                            </a>
                                        </div>
                                    </th>  
                                    <th scope="col">
                                        Inventory
                                        <div style="float: right;">
                                            <a href="{{ route('product.index_instock', array_merge(request()->all(), ['sort' => 'inventory_asc'])) }}">
                                                <i class="fas fa-arrow-up"></i>
                                            </a>
                                            <a href="{{ route('product.index_instock', array_merge(request()->all(), ['sort' => 'inventory_desc'])) }}">
                                                <i class="fas fa-arrow-down"></i>
                                            </a>
                                        </div>
                                    </th>
                                    <th scope="col">
                                        Price
                                        <div style="float: right;">
                                            <a href="{{ route('product.index_instock', array_merge(request()->all(), ['sort' => 'price_asc'])) }}">
                                                <i class="fas fa-arrow-up"></i>
                                            </a>
                                            <a href="{{ route('product.index_instock', array_merge(request()->all(), ['sort' => 'price_desc'])) }}">
                                                <i class="fas fa-arrow-down"></i>
                                            </a>
                                        </div>
                                    </th>
...
<script>
    ...
    document.getElementById('reset-search').addEventListener('click', function() {
        ...
        window.location.href="{{ route('product.index_instock') }}";
    });
</script>
