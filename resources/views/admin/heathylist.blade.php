                ...
                <div class="table-responsive">
                    <table class="table text-start align-middle table-bordered table-hover mb-0" style="
                        ...
                        <tbody>
                            ...
                            <tr id="row-{{ $heathy->heath_id }}" style="background-color: #f9f9f9; transition: background-color 0.3s ease;">
                                <td>{{ ($heathies->currentPage() - 1) * $heathies->perPage() + $loop->iteration }}</td>
                                <td id="name-cell-{{ $heathy->heath_id }}">{{ $heathy->heath_catalog }}</td>
                                <td>
                                    <a href="javascript:void(0);" class="bi bi-pencil m-2" style="color: #007bff;" data-category-id="{{ $heathy->heath_id }}" data-update-url="{{ route('heathy.update', ['heathy' => $heathy->heath_id]) }}" onclick="editRow(this)">
                                    </a>
                                    <a class="btn" href="#" data-url="{{ route('heathy.destroy', $heathy->heath_id) }}" onclick="showDeleteModal(this)" style="
