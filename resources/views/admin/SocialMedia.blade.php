...
<!-- Search Form -->
    ...
    <div class="col-md-4">
    <form action="{{ route('admin.socialmedia.index') }}" method="GET" class="d-flex mb-3">
    ...
    <div class="col-md-4">
    <a href="{{ route('admin.socialmedia.index') }}" class="btn btn-secondary">Reset</a>
    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <!-- Edit Button -->
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#editSocialMediaModal-{{ $media->SocialMedia_id }}">Edit</button>
